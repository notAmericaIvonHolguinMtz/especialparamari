...
togglePlayer.addEventListener("click", function() {
    ...
    if(isHidden){
        ...
        togglePlayer.innerHTML = '<img class="w-[98%]" src="iconos/close.svg">';
        trackInfo.style.transitionDelay = "0.4s";
        trackNav.style.transitionDelay = "0.4s";
    } else {
        musicPlayer.classList.add("hide");
        togglePlayer.innerHTML = '<img class="w-full" src="iconos/plus.svg">';
...
let trackList = [
    ...
    },
    {
        ...
        path: "./musica/Follow.mp3",
    },
    {
        name: "Alma Dinamita",
        artist: "Wos",
        path: "./musica/ALMA DINAMITA.mp3",
    },
    {
        name: "The Only One",
        artist: "Reyne",
...
function playTrack(){
    currentTrack.play();
    isPlaying = true;
    playPauseBtn.innerHTML = '<img class="w-8" src="iconos/pause.svg">';
...
function pauseTrack(){
    currentTrack.pause();
    isPlaying = false;
    playPauseBtn.innerHTML = '<img class="w-8" src="iconos/play.svg">';
